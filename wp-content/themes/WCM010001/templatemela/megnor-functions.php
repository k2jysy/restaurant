...
{
	add_option("tmoption_logo_image", get_template_directory_uri()."/images/megnor/logo.png"); // set logo image	
	add_option("tmoption_logo_image_alt",'Restaurant'); // set logo image alt
	add_option("tmoption_showsite_description",'no'); // yes/no, control panel	
	add_option("tmoption_favicon_icon", get_template_directory_uri()."/images/megnor/favicon.png"); // set favicon icon		
	add_option("tmoption_contact_email",'demo.templatemela@gmail.com'); // yes/no, control panel
	...
	//add_option("tmoption_texture",""); // Default, extra texture image
	...
	add_option("tmoption_button_color","B4D2D0"); // button color
	add_option("tmoption_button_hover_color","959B8F"); // button hover color
	
	
	
	/*  Top Bar Settings  */	
	/*add_option("tmoption_show_topbar","yes"); // show top bar
	add_option("tmoption_topbar_bkg_color","333333"); // topbar_bkg_color
	add_option("tmoption_topbar_text_color","ACACAC"); // topbar_text_color
	add_option("tmoption_topbar_link_color","ACACAC"); // topbar_link_color
	add_option("tmoption_topbar_link_hover_color","FFFFFF"); // topbar_link_hover_color
	add_option("tmoption_show_topbar_social","no"); // show_topbar_social
	...
	add_option("tmoption_custom_text1_desc","At vero eos et accusamus et iusto odio dignis"); // Custom Text 1 desc
	add_option("tmoption_custom_text2","Free Return For 90 Days"); // Custom Text 2
	add_option("tmoption_custom_text2_desc","At vero eos et accusamus et iusto odio dignis"); // Custom Text 2 desc
	add_option("tmoption_custom_text3","Discount On Order Gift"); // Custom Text 3	
	add_option("tmoption_custom_text3_desc","At vero eos et accusamus et iusto odio dignis")*/; // Custom Text 3 desc
	
	/*  Header Settings  */	
	add_option("tmoption_header_layout","2"); // header layout
	add_option("tmoption_header_background_upload", get_template_directory_uri()."/images/megnor/top-line.png");
	add_option("tmoption_header_back_repeat","repeat-x"); // header background repeate
	...
	add_option("tmoption_contact_panel","yes");
	add_option("tmoption_topbar_phone","000-222-3333");
	add_option("tmoption_Contact_Text","Home Delivery : ");
	add_option("tmoption_header_bkg_color","F0F0F0"); // header background color	
	...
	add_option("tmoption_header_menu_color1","FCC180");
	add_option("tmoption_header_menu_color2","ACB1E2");
	add_option("tmoption_header_menu_color3","959B8F");
	add_option("tmoption_header_menu_color4","B4D2D0");
	add_option("tmoption_header_menu_color5","F4DF86");
	add_option("tmoption_header_menu_color6","5C483C");
	add_option("tmoption_navigation_background_upload", get_template_directory_uri()."/images/megnor/menu_bg.png");
	...
	/*  Footer Settings  */
	add_option("tmoption_footer_background_upload", get_template_directory_uri()."/images/megnor/footer-bg.png");
	add_option("tmoption_footer_back_repeat","repeat-x"); // header background repeate
	add_option("tmoption_footer_back_position","top+center"); // header background position
	add_option("tmoption_footer_back_attachment","scroll"); // header background attachment		
...
/*add_action( 'get_header', 'tm_favicon' );*/
...
function templatemela_load_fonts() {
	...
	wp_enqueue_style( 'Cabin-user', "$protocol://fonts.googleapis.com/css?family=Cabin Slab:300,400,500,600,700" );
}
endif;
...
function templatemela_get_topbar_contact() {
	...
	$tmoption_Contact_Text = get_option('tmoption_Contact_Text');
	$output = '';
	$output .= '<div class="topbar-contact">';
		...
		$output .= '<div class="phone-content content"><span class="contact-text">'.$tmoption_Contact_Text.'</span><span class="contact-phone">'.$tmoption_topbar_phone.'</span></div>';
...
function tm_post_entry_date( ) {
	...
	$date = '<div class="entry-date"><i class="fa fa-clock-o"></i><div class="month">'.$month.'</div><div class="day">'.$day.'</div>,<div class="year">'.$year.'</div></div>';
	echo $date;
	return $date;
}
endif;
...
function tm_page_layout() {
	$page_layout_class = '';
	$tm_page_layout = get_post_meta(get_the_ID(), 'tm_page_layout', true);
...
add_image_size( 'blog-posts-list', 700, 300, true );
...
function woocommerce_output_related_products() {
	$no = get_option("tmoption_related_items");
     woocommerce_related_products($no,2); // Display 4 products in rows of 2
}
...
function woocommerce_output_upsells() {
	    ...
	    woocommerce_upsell_display( $no1,2 ); 
}
