...
$options2[] = array("id" => "tmoption_contact_panel",
					"label" => "Show Contact Number?",
					"type" => "select",
					"description" => "Enable or Disable Contact No.",
					"options" => array('yes' => 'Yes','no' => 'No'));

$options2[] = array("id" => "tmoption_Contact_Text",
					"label" => "Your Text",
					"type" => "textbox",
					"description" => "Change your Contact Text.");


$options2[] = array("id" => "tmoption_topbar_phone",
					"label" => "Phone No",
					"type" => "textbox",
...
$options2[] = array("id" => "tmoption_navigation_background_upload",
					"label" => "Upload Navigation Background Image",
					"type" => "upload-1",
					"description" => "Upload Your Navigation Background Image.");		
