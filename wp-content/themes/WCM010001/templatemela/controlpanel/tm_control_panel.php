...
<style type="text/css">
	...
	.navbar .nav-menu li a{	
		font-family:'<?php echo esc_attr( str_replace('+',' ',get_option('tmoption_navfont_other')) ); ?>', Arial, Helvetica, sans-serif;	
	}	
	<?php } } elseif(get_option('tmoption_navfont') != "" && get_option('tmoption_navfont') != "please-select"){ ?>
	.navbar .nav-menu li a{	
		font-family:'<?php echo esc_attr( str_replace('+',' ',get_option('tmoption_navfont')) ); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>
	...
	.site-footer {
		...
		background-color:#<?php echo esc_attr( get_option('tmoption_footer_background_upload') ) ; ?>;
		<?php if(get_option('tmoption_footer_background_upload')!=''){ ?>
		background-image: url("<?php echo esc_url( get_option('tmoption_footer_background_upload') ); ?>");
		background-position:<?php echo esc_attr( str_replace('+',' ',get_option('tmoption_footer_back_position')) ); ?>;
		background-repeat:<?php echo esc_attr( get_option('tmoption_footer_back_repeat') ); ?>;
		background-attachment:<?php echo esc_attr( get_option('tmoption_footer_back_attachment') ); ?>;
		<?php } ?>
	}
	...
	body {
		...
		<?php /*?>background-image: url("<?php echo get_template_directory_uri(); ?>/images/megnor/colorpicker/pattern/<?php echo get_option('tmoption_texture'); ?>");<?php */?>
	...
	.topbar-outer { 
		background-color:#<?php echo esc_attr( get_option('tmoption_topbar_bkg_color') ) ; ?>; 
	}
	.topbar-main { color:#<?php echo esc_attr( get_option('tmoption_topbar_text_color') ); ?>; }
	.topbar-main a{ color:#<?php echo esc_attr( get_option('tmoption_topbar_link_color') ); ?>; }
	.topbar-main a:hover{ color:#<?php echo esc_attr( get_option('tmoption_topbar_link_hover_color') ); ?>; }
	.site-header {
		background-color:#<?php echo esc_attr( get_option('tmoption_header_bkg_color') ) ; ?>;
		<?php if(get_option('tmoption_header_background_upload')!=''){ ?>
		background-image: url("<?php echo esc_url( get_option('tmoption_header_background_upload') ); ?>");
	...
	background: url("<?php echo esc_url( get_option('tmoption_navigation_background_upload') ); ?>") no-repeat scroll center center #<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?> ;}	
.mega-menu .menu1 span, .mega-menu .menu7 span{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?>; }
.mega-menu .menu2 span, .mega-menu .menu8 span{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color2') ); ?>; }
.mega-menu .menu3 span, .mega-menu .menu9 span{ background-color: #<?php echo esc_attr( get_option('tmoption_header_menu_color3') ); ?>; }
.mega-menu .menu4 span, .mega-menu .menu10 span { background-color: #<?php echo esc_attr( get_option('tmoption_header_menu_color4') ); ?>; }
.mega-menu .menu5 span, .mega-menu .menu11 span { background-color: #<?php echo esc_attr( get_option('tmoption_header_menu_color5') ); ?>; }
.mega-menu .menu6 span , .mega-menu .menu12 span{ background-color: #<?php echo esc_attr( get_option('tmoption_header_menu_color6') ); ?>; }

.mega-menu .menu1 ul, .mega-menu .menu7 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?>;  }
.mega-menu .menu2 ul, .mega-menu .menu8 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color2') ); ?>; }
.mega-menu .menu3 ul, .mega-menu .menu9 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color3') ); ?>; }
.mega-menu .menu4 ul, .mega-menu .menu10 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color4') ); ?>; }
.mega-menu .menu5 ul, .mega-menu .menu11 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color5') ); ?>; }
.mega-menu .menu6 ul, .mega-menu .menu12 ul{ border:1px solid #<?php echo esc_attr( get_option('tmoption_header_menu_color6') ); ?>; }

.mega-menu .menu1:hover ul a:hover, .mega-menu .menu7:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?>; color:#FFF !important; }
.mega-menu .menu2:hover ul a:hover, .mega-menu .menu8:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color2') ); ?>; color:#FFF !important; }
.mega-menu .menu3:hover ul a:hover, .mega-menu .menu9:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color3') ); ?>; color:#FFF !important; }
.mega-menu .menu4:hover ul a:hover, .mega-menu .menu10:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color4') ); ?>; color:#FFF !important; }
.mega-menu .menu5:hover ul a:hover, .mega-menu .menu11:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color5') ); ?>; color:#FFF !important; }
.mega-menu .menu6:hover ul a:hover, .mega-menu .menu12:hover ul a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_menu_color6') ); ?>; color:#FFF !important; }

.mega-menu li.menu1 a:hover, .mega-menu li.menu7 a:hover,
.mega-menu li.current-menu-item.menu1 a:hover, .mega-menu li.current-menu-item.menu7 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?>; }
.mega-menu li.menu2 a:hover, .mega-menu li.menu8 a:hover,
.mega-menu li.current-menu-item.menu2 a:hover, .mega-menu li.current-menu-item.menu8 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color2') ); ?>; }
.mega-menu li.menu3 a:hover, .mega-menu li.menu9 a:hover,
.mega-menu li.current-menu-item.menu3 a:hover, .mega-menu li.current-menu-item.menu9 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color3') ); ?>; }
.mega-menu li.menu4 a:hover, .nav-menu li.menu10 a:hover,
.mega-menu li.current-menu-item.menu4 a:hover, .mega-menu li.current-menu-item.menu10 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color4') ); ?>; }
.mega-menu li.menu5 a:hover, .mega-menu li.menu11 a:hover,
.mega-menu li.current-menu-item.menu5 a:hover, .mega-menu li.current-menu-item.menu11 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color5') ); ?>; }
.mega-menu li.menu6 a:hover, .mega-menu li.menu12 a:hover,
.mega-menu li.current-menu-item.menu6 a:hover, .mega-menu li.current-menu-item.menu12 a:hover { color: #<?php echo esc_attr( get_option('tmoption_header_menu_color6') ); ?>; }	
