...
class CMSBlockWidget extends WP_Widget
{
    function CMSBlockWidget(){
		...
		parent::WP_Widget(false,$name='TM - Header CMS Block Widget',$widget_settings);
    }
    function widget($args, $instance){
		...
		echo $befote_widget;
		 ...
		 <div class="header_banner">
		 	<ul>
				<li class="shipping"> <a href="<?php if($linkURL1 == ""): echo esc_url(home_url( '/' )); else:?><?php echo esc_url($linkURL1); endif;?>" <?php if($window_target1 == true) echo 'target="_blank"'; ?> > <?php echo esc_attr($main_title); ?> </a> </li>
				<li class="Money"> <a href="<?php if($linkURL2 == ""): echo esc_url(home_url( '/' )); else:?><?php echo esc_url($linkURL2); endif;?>" <?php if($window_target2 == true) echo 'target="_blank"'; ?> ><?php echo esc_attr($main_title_2); ?> </a></li>
				<li class="Offer"> <a href="<?php if($linkURL3 == ""): echo esc_url(home_url( '/' )); else:?><?php echo esc_url($linkURL3); endif;?>" <?php if($window_target3 == true) echo 'target="_blank"'; ?> > <?php echo esc_attr($main_title_3); ?> </a></li>
			</ul>
		 </div>
