...
class FlickrWidget extends WP_Widget
{
    ...
    function form($instance){
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('flickrid'));?>"><?php _e('ID:', 'templatemela'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('flickrid'));?>" name="<?php echo esc_attr($this->get_field_name('flickrid'));?>" type="text" value="<?php echo esc_attr($flickrid);?>" /></p>
		<p><label for="<?php echo esc_attr($this->get_field_id('photocount'));?>"><?php _e('No of Photo to Display:', 'templatemela'); ?><br /></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('photocount'));?>" name="<?php echo esc_attr($this->get_field_name('photocount'));?>" type="text" value="<?php echo esc_attr($photocount);?>" />
		<?php
	}
}
