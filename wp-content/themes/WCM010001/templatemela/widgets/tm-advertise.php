...
<div class="advertise"> <a href="<?php echo esc_url($linkURL);?>" title="<?php echo  esc_attr($imageTitle);?>" <?php if($window_target == true) echo 'target="_blank"'; ?>> <img src="<?php echo esc_url($imageSrc); ?>" id="<?php echo  esc_attr($imageTitle);?>" alt="<?php echo  esc_attr($imageAlt);?>" title="<?php echo  esc_attr($imageTitle);?>" /> </a> </div>
...
<p>
  ...
  <input class="widefat" id="<?php echo $this->get_field_id('imageTitle');?>" name="<?php echo $this->get_field_name('imageTitle');?>" type="text" value="<?php echo  esc_attr($imageTitle);?>" />
</p>
<p>
  <label for="<?php echo $this->get_field_id('imageAlt');?>"><?php _e('Image Alt:', 'templatemela'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('imageAlt');?>" name="<?php echo $this->get_field_name('imageAlt');?>" type="text" value="<?php echo  esc_attr($imageAlt);?>" />
</p>
<p>
