...
function templatemela_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', __( '<span class="meta-nav">Published In</span>%title', 'templatemela' ) );
			else :
				previous_post_link( '%link', __( '<i class="fa fa-chevron-left"></i>%title', 'templatemela' ) );
				next_post_link( '%link', __( '%title<i class="fa fa-chevron-right"></i>', 'templatemela' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
